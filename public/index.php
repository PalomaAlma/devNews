...
$router->get('/admin/user/show/:id', 'App\Controller\Admin\UserController@showUser');
$router->post('/admin/user/show/:id', 'App\Controller\Admin\UserController@validUser');
